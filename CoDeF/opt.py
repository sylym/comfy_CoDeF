...
def get_opts():
    ...
    parser.add_argument('--save_model_iters', type=int, default=0,
    ...
    ##### Additional losses ######
    parser.add_argument('--flow_loss', type=float, default=0,
                        help='optical flow loss weight')
    parser.add_argument('--bg_loss', type=float, default=0.003,
    ...
    parser.add_argument('--self_bg', type=bool_parser, default=True,
